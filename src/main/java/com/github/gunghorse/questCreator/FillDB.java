    ...
    */
    ...
    public void run(String... args) throws Exception {
        ...
        QuestStartPoint barbakan = QuestStartPoint.builder()
                ...
                .location(new Point(50.065514, 19.941617))
                .build();
        ...
        QuestPoint bramaFloreanska = QuestPoint.builder()
                ...
                .location(new Point(50.064861, 19.941389))
                .build();
        ...
        QuestPoint kosciolMariacki = QuestPoint.builder()
                ...
                .location( new Point(50.061667, 19.939167))
                .build();
        ...
        QuestPoint sukiennice = QuestPoint.builder()
                ...
                .location(new Point(50.061667, 19.937222))
                .build();
        ...
        QuestPoint stAnne = QuestPoint.builder()
                ...
                .location( new Point(50.0610393,19.9375758))
                .build();
        ...
        QuestPoint uj = QuestPoint.builder()
                ...
                .location(new Point(50.0609153,19.9355373))
                .build();
        ...
        QuestPoint stFranciszek = QuestPoint.builder()
                ...
                .location(new Point(50.0587663,19.9338958))
                .build();
        ...
        QuestPoint wsd = QuestPoint.builder()
                ...
                .location(new Point(50.0557958,19.9349901))
                .build();
        ...
        QuestPoint poitraIPawla = QuestPoint.builder()
                ...
                .location(new Point(50.0569298,19.9379164))
                .build();
        ...
        QuestPoint stAndrzej = QuestPoint.builder()
                ...
                .location( new Point(50.0567455,19.9380371))
                .build();
        ...
        QuestPoint stIdzi = QuestPoint.builder()
                ...
                .location( new Point(50.0552094,19.9379017))
                .build();
        ...
        QuestPoint wawel = QuestPoint.builder()
                ...
                .location(new Point(50.0520527,19.9370058))
                .build();
